...
void sr_handle_icmp(struct sr_instance *sr, sr_ethernet_hdr_t *ethh, struct sr_if *in_interface, uint8_t type, uint8_t code, uint8_t point, struct sr_if *outbound, sr_ip_tr_hdr_t *ip_tr);
